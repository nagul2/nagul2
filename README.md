<h3 align="center">
AI 시대에 맞춰 기획과 개발 역량을 함께 키워가는 풀스택 개발자입니다.
</h3>
...
- `tmux` 터미널 분할 환경에서 Claude Code, Gemini CLI 등 다중 AI 모델을 동시에 구동하여 문제 해결과 교차 검증을 수행합니다.
- 단일 AI의 결과물을 맹신하지 않고, 시스템 아키텍처와 비즈니스 요구사항에 가장 적합한 로직을 개발자가 직접 판단 및 검토하여 최종 반영하는 철저한 워크플로우를 지향합니다.
...
<p align="center">
  <img src="https://img.shields.io/badge/Spring%20Boot%20Actuator-6DB33F?style=for-the-badge&logo=springboot&logoColor=white"/>
...
<table align="center">
  <tr>
    <td align="center">
      <img src="https://fork-github-readme-stats-beryl.vercel.app/api/top-langs/?username=nagul2&layout=compact&theme=github_dark&hide_border=true&hide=html,css,PLpgSQL,Shell,Dockerfile" />
    </td>
    <td align="center">
